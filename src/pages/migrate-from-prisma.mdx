...
6. Transition your **Prisma** queries to **Drizzle ORM** queries.
...
```sql copy filename="prisma/migrations/20240101200233_init/migration.sql"
-- CreateTable
...
```sql copy filename="src/drizzle/0000_cool_puff_adder.sql"
...
## Step 6: Transition your Prisma queries to Drizzle ORM queries
